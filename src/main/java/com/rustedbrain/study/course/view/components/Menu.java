...
public class Menu extends CustomComponent {
    ...
    public Menu() {
        ...
        List<Button> buttons = Arrays.asList(
                ...
                VaadinSession.getCurrent().getAttribute(LoginViewImpl.LOGGED_USER_ATTRIBUTE) != null ? createNavigationButton("Profile", VaadinUI.PROFILE_VIEW) : createNavigationButton("Login", VaadinUI.LOGIN_VIEW),
                VaadinSession.getCurrent().getAttribute(LoginViewImpl.LOGGED_USER_ATTRIBUTE) != null ? null : createNavigationButton("Registration", VaadinUI.REGISTRATION_VIEW),
                VaadinSession.getCurrent().getAttribute(LoginViewImpl.LOGGED_USER_ATTRIBUTE) != null ? createLogoutButton() : null
        );
