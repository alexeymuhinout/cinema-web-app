        ...
        if (optionalId.isPresent()) {
            ...
            if (optionalUserInfo.isPresent()) {
                ...
                if (authenticationService.isAuthenticated()) {
                    this.view.showUserInfo(userInfo, (UserRole.MODERATOR.equals(authenticationService.getUserRole()) || UserRole.ADMINISTRATOR.equals(authenticationService.getUserRole())));
                } else {
